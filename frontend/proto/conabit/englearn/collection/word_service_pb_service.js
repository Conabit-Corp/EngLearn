...
var proto_conabit_englearn_collection_word_service_pb = require("../../../../proto/conabit/englearn/collection/word_service_pb");
var grpc = require("@improbable-eng/grpc-web").grpc;

var WordService = (function () {
  function WordService() {}
  WordService.serviceName = "conabit.englearn.collection.WordService";
  return WordService;
}());
...
WordService.RegisterWordPair = {
  ...
  requestType: proto_conabit_englearn_collection_word_service_pb.RegisterWordPairRequest,
  responseType: proto_conabit_englearn_collection_word_service_pb.WordPair
};
...
WordService.CloneWordPair = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: proto_conabit_englearn_collection_word_service_pb.CloneWordPairRequest,
  responseType: proto_conabit_englearn_collection_word_service_pb.WordPair
};
...
WordService.FindUserWords = {
  ...
  requestStream: false,
  responseStream: true,
  requestType: proto_conabit_englearn_collection_word_service_pb.LogOutRequest,
  responseType: proto_conabit_englearn_collection_word_service_pb.WordPair
};
